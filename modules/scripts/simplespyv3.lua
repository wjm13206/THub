...
local Highlight = (isfile and loadfile and isfile("Highlight.lua") and loadfile("Highlight.lua")()) or loadstring(game:HttpGet("https://raw.atomgit.com/Furrycalin/ScriptStorage/raw/main/highlight.lua"))()
local LazyFix = loadstring(game:HttpGet("https://raw.atomgit.com/Furrycalin/ScriptStorage/raw/main/DataToCode.lua"))() -- Very lazy fix as I'm legit just pasting it from the rewrite
...
if not getgenv().SimpleSpyExecuted then
    local succeeded,err = pcall(function()
        ...
        logthread(spawn(function()
            local suc,err = pcall(game.HttpGet,game,"https://raw.atomgit.com/Furrycalin/ScriptStorage/raw/main/update.txt")
