...
Title.TextSize = 18
Title.Text = "无限收益 FE v" .. currentVersion
...
ColorsButton = makeSettingsButton("编辑主题",getcustomasset("infiniteyield/assets/edittheme.png"))
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("编辑快捷键",getcustomasset("infiniteyield/assets/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("编辑别名",getcustomasset("infiniteyield/assets/editaliases.png"))
...
Positions = makeSettingsButton("编辑/传送至路径点",getcustomasset("infiniteyield/assets/editwaypoints.png"))
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("编辑事件绑定",getcustomasset("infiniteyield/assets/bindsandplugins.png"),759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("管理插件",getcustomasset("infiniteyield/assets/bindsandplugins.png"),743)
...
Directions.Text = "点击下面的按钮然后按下按键/鼠标按钮。然后选择要绑定的触发方式。"
...
About.TextSize = 14
About.Text = "插件是 .iy 文件，应该放在你的注入器的 'workspace' 文件夹中。"
...
Directions_2.Text = "在下面输入你要添加的插件文件名。"
...
AliasHint.Text = "使用 'addalias' 命令添加别名"
...
PluginsHint.Text = "从 IY Discord 下载插件 (discord.gg/78ZuWSq)"
...
PositionsHint.Text = "使用 'swp' 或 'setwaypoint' 命令通过你的角色添加位置（注意：部件传送不会保存）"
...
Directions_3.Text = '点击一个部件然后点击下面的"选择部件"按钮将其设置为传送位置'
...
eventEditor = (function()
	...
	local main = create({
		...
		{3,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={2},Position=UDim2.new(0,0,0,0),Size=UDim2.new(1,0,0.95,0),Text="事件编辑器",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=Enum.TextXAlignment.Center,ZIndex=10,}},
		...
		{16,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={11},Size=UDim2.new(1,0,0,20),Text="事件设置",TextColor3=Color3.new(1,1,1),TextSize=14,ZIndex=10,}},
		...
		{20,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={19},Size=UDim2.new(1,0,0,20),Text="选择玩家",TextColor3=Color3.new(1,1,1),TextSize=14,ZIndex=10,}},
		{21,"TextLabel",{BackgroundColor3=Color3.new(0.1803921610117,0.1803921610117,0.1843137294054),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Any",Parent={19},Position=UDim2.new(0,5,0,42),Size=UDim2.new(1,-10,0,20),Text="任意玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=10,}},
		...
		{24,"TextLabel",{BackgroundColor3=Color3.new(0.1803921610117,0.1803921610117,0.1843137294054),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Me",Parent={19},Position=UDim2.new(0,5,0,20),Size=UDim2.new(1,-10,0,20),Text="仅自己",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=10,}},
		...
		{31,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={30},Size=UDim2.new(1,0,0,20),Text="选择字符串",TextColor3=Color3.new(1,1,1),TextSize=14,ZIndex=10,}},
		{32,"TextLabel",{BackgroundColor3=Color3.new(0.1803921610117,0.1803921610117,0.1843137294054),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Any",Parent={30},Position=UDim2.new(0,5,0,20),Size=UDim2.new(1,-10,0,20),Text="任意字符串",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=10,}},
		...
		{55,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={54},Size=UDim2.new(1,0,0,20),Text="选择字符串",TextColor3=Color3.new(1,1,1),TextSize=14,ZIndex=10,}},
		{56,"TextLabel",{BackgroundColor3=Color3.new(0.1803921610117,0.1803921610117,0.1843137294054),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Any",Parent={54},Position=UDim2.new(0,5,0,20),Size=UDim2.new(1,-10,0,20),Text="任意数字",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=10,}},
		...
		{40,"TextLabel",{BackgroundColor3=Color3.new(0.1803921610117,0.1803921610117,0.1843137294054),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Label",Parent={39},Position=UDim2.new(0,-55,0,0),Size=UDim2.new(1,0,1,0),Text="延迟(秒):",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=10,}},
		...
		{46,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClearTextOnFocus=false,Font=3,Parent={45},PlaceholderColor3=Color3.new(0.7843137383461,0.7843137383461,0.7843137383461),PlaceholderText="添加新命令",Position=UDim2.new(0,5,0,0),Size=UDim2.new(1,-10,1,0),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=10,}},
	...
	local function openSettingsEditor(event,cmd)
		...
		for i,v in pairs(event.sets) do
			if v.Type == "Player" then
				...
				template.Title.Text = v.Name or "玩家"
			...
			elseif v.Type == "String" then
				...
				template.Title.Text = v.Name or "字符串"
			...
			elseif v.Type == "Number" then
				...
				template.Title.Text = v.Name or "数字"
...
reference = (function()
	local main = create({
		...
		{3,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={2},Size=UDim2.new(1,0,0.94999998807907,0),Text="参考指南",TextColor3=Color3.new(1,1,1),TextSize=14,ZIndex=10,}},
		{4,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Close",Parent={2},Position=UDim2.new(1,-20,0,0),Size=UDim2.new(0,20,0,20),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,ZIndex=10,}},
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("infiniteyield/assets/close.png"),Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{10,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={9},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="特殊玩家案例",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={9},Position=UDim2.new(0,8,0,25),Size=UDim2.new(1,-8,0,20),Text="这些关键词可用于在命令中快速选择玩家组:",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{17,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={15},Position=UDim2.new(0,15,0,0),Size=UDim2.new(1,0,1,0),Text="- 包括所有人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{20,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={18},Position=UDim2.new(0,37,0,0),Size=UDim2.new(1,0,1,0),Text="- 包括除你以外的所有人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{23,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={21},Position=UDim2.new(0,19,0,0),Size=UDim2.new(1,0,1,0),Text="- 只包括你自己",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{26,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={24},Position=UDim2.new(0,59,0,0),Size=UDim2.new(1,0,1,0),Text="- 获取指定数量的随机玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{29,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={27},Position=UDim2.new(0,44,0,0),Size=UDim2.new(1,0,1,0),Text="- 影响一个随机玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{32,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={30},Position=UDim2.new(0,78,0,0),Size=UDim2.new(1,0,1,0),Text="- 包括给定队伍的所有人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{35,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={33},Position=UDim2.new(0,63,0,0),Size=UDim2.new(1,0,1,0),Text="- 与你同队的玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{38,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={36},Position=UDim2.new(0,101,0,0),Size=UDim2.new(1,0,1,0),Text="- 与你不同队的玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{41,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={39},Position=UDim2.new(0,40,0,0),Size=UDim2.new(1,0,1,0),Text="- 任何与你是好友的人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{44,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={42},Position=UDim2.new(0,61,0,0),Size=UDim2.new(1,0,1,0),Text="- 任何与你不是好友的人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{47,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={45},Position=UDim2.new(0,36,0,0),Size=UDim2.new(1,0,1,0),Text="- 访客玩家（已过时）",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{50,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={48},Position=UDim2.new(0,40,0,0),Size=UDim2.new(1,0,1,0),Text="- 任何有\"培根\"或pal头发的人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{53,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={51},Position=UDim2.new(0,71,0,0),Size=UDim2.new(1,0,1,0),Text="- 包括小于或等于给定年龄的任何人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{56,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={54},Position=UDim2.new(0,70,0,0),Size=UDim2.new(1,0,1,0),Text="- 包括给定半径内的任何人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{59,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={57},Position=UDim2.new(0,43,0,0),Size=UDim2.new(1,0,1,0),Text="- 获取离你最近的玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{62,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={60},Position=UDim2.new(0,46,0,0),Size=UDim2.new(1,0,1,0),Text="- 获取离你最远的玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{65,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={63},Position=UDim2.new(0,55,0,0),Size=UDim2.new(1,0,1,0),Text="- 获取在特定群组中的玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{68,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={66},Position=UDim2.new(0,27,0,0),Size=UDim2.new(1,0,1,0),Text="- 获取存活的玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{71,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={69},Position=UDim2.new(0,29,0,0),Size=UDim2.new(1,0,1,0),Text="- 获取死亡的玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{74,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={72},Position=UDim2.new(0,66,0,0),Size=UDim2.new(1,0,1,0),Text="- 仅通过用户名搜索玩家（忽略显示名）",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{76,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={75},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="各种运算符",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		...
		{78,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={75},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,16),Text="使用逗号分隔多个表达式:",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		{79,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={75},Position=UDim2.new(0,8,0,75),Size=UDim2.new(1,-8,0,16),Text="使用 - 排除，使用 + 在表达式中包含玩家:",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		{80,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={75},Position=UDim2.new(0,8,0,91),Size=UDim2.new(1,-8,0,16),Text=";locate %blue-friends（获取蓝队中不是你好友的玩家）",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		...
		{82,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={75},Position=UDim2.new(0,8,0,120),Size=UDim2.new(1,-8,0,16),Text="在命令前加上 ! 可以使用上次运行该命令的参数:",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		{83,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={75},Position=UDim2.new(0,8,0,136),Size=UDim2.new(1,-8,0,32),Text="运行 ;offset 0 100 0 后，你可以随时运行 !offset 使用上次相同的参数重复该命令",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		...
		{85,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={84},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="命令循环",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{86,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={84},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,20),Text="格式: [循环次数]^[延迟(可选)]^[命令]",TextColor3=Color3.new(1,1,1),TextSize=15,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{88,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={84},Position=UDim2.new(0,8,0,50),Size=UDim2.new(1,-8,0,20),Text="使用 'breakloops' 命令停止所有正在运行的循环。",TextColor3=Color3.new(1,1,1),TextSize=15,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		{89,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={84},Position=UDim2.new(0,8,0,80),Size=UDim2.new(1,-8,0,16),Text="示例:",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		{90,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={84},Position=UDim2.new(0,8,0,98),Size=UDim2.new(1,-8,0,42),Text=";5^btools - 给你5套建筑工具\n;10^3^drophats - 每3秒扔一次帽子，共10次\n;inf^0.1^animspeed 100 - 无限循环将动画速度设为100",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		...
		{92,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={91},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="同时执行多个命令",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{93,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={91},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,20),Text="你可以使用 \"\\\" 同时执行多个命令",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{95,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={91},Position=UDim2.new(0,8,0,60),Size=UDim2.new(1,-8,0,16),Text="示例:",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		{96,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={91},Position=UDim2.new(0,8,0,78),Size=UDim2.new(1,-8,0,32),Text=";drophats\\respawn - 扔掉你的帽子并重生\n;enable inventory\\enable playerlist\\refresh - 启用那些核心GUI项目并刷新你",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		...
		{98,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={97},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="浏览命令历史",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{99,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={97},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="当焦点在命令栏上时，你可以使用上下箭头键浏览最近使用的命令",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{102,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={101},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="命令栏中的自动补全",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{103,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={101},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="当焦点在命令栏上时，你可以使用Tab键将建议的顶部命令插入到命令栏中。",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{106,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={105},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="使用事件绑定",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{107,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={105},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="使用事件绑定设置在特定事件发生时执行的命令。你可以编辑事件命令运行的条件（例如哪个玩家触发它）。",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{109,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={105},Position=UDim2.new(0,8,0,70),Size=UDim2.new(1,-8,0,48),Text="一些事件可能会发送参数；你可以在事件命令中使用 $ 后跟参数编号（$1、$2等）来使用它们。你可以通过查看事件命令的设置来了解这些参数的顺序和类型。",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		{110,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={105},Position=UDim2.new(0,8,0,130),Size=UDim2.new(1,-8,0,16),Text="示例:",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		{111,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={105},Position=UDim2.new(0,8,0,148),Size=UDim2.new(1,-8,0,16),Text="在 OnChatted 事件上设置 'goto $1' 将使你传送到任何在聊天中发言的玩家。",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		...
		{113,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={112},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="获取更多帮助",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{114,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={112},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="你可以加入 Discord 服务器获取 IY 的支持，并阅读更多文档，例如插件 API。",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			...
			inviteButton.Text = "已复制"
		else
			inviteButton.Text = "无剪贴板功能，请手动输入链接"
		end
		local pressTime = tick()
		lastPress = pressTime
		wait(2)
		if lastPress ~= pressTime then return end
		inviteButton.Text = "复制 Discord 邀请链接 (https://discord.gg/78ZuWSq)"
	end)
	dragGUI(main)
	main.Parent = ScaledHolder
...
function saves()
	if writefileExploit() and readfileExploit() and jsonAttempts < 10 then
		...
		if readSuccess then
			if out ~= nil and tostring(out):gsub("%s", "") ~= "" then
				...
				if dReadSuccess and dOut ~= nil and tostring(dOut):gsub("%s", "") ~= "" then
					...
					nosaves = true
					useFactorySettings()
					createPopup("文件错误", "无法在你的电脑上写入保存文件。\n\n请联系你的注入器的开发者/支持团队，告诉他们 writefile/readfile 无法正常工作。\n\n如果继续，你的设置、快捷键、路径点和别名将不会保存。\n\n可以尝试:\n> 确保在注入器所在的文件夹中有一个 'workspace' 文件夹\n> 如果你的注入器在 zip/rar 文件中，请解压它。\n> 重新加入游戏再试一次，或重启电脑再试一次。")
				end
			end
		else
			writefile("IY_FE.iy", defaults, true)
		...
		if jsonAttempts >= 10 then
			nosaves = true
			useFactorySettings()
			createPopup("文件错误", "抱歉，我们尝试解析你的保存文件，但它无法读取！\n\n无限收益现在正在使用出厂设置，直到你的注入器的文件系统正常工作。\n\n你的保存文件尚未被删除。")
		else
			nosaves = true
			useFactorySettings()
		end
...
if not writefileExploit() then
	notify("保存", "你的注入器不支持读写文件。你的设置将不会保存。")
end
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- 无限收益 聊天日志 for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
			...
			local function nameFile()
				local file
				pcall(function() file = readfile(placeName..' 聊天日志 ('..fileext..').txt') end)
				if file then
					fileext = fileext+1
					nameFile()
				else
					writefileCooldown(placeName..' 聊天日志 ('..fileext..').txt', writelogsFile)
				end
			end
			nameFile()
			notify('聊天日志','已将聊天日志保存到注入器文件夹中的 workspace 文件夹。')
		end
	else
		notify('聊天日志','你的注入器不支持写入文件。无法保存聊天日志。')
	end
end)
	...
	if Path.Text ~= "" then
		...
		local function handleWpNames()
			...
			if not FoundDupe then
				notify('路径点已修改',"已创建路径点: "..selected.Adornee.Name..tpNameExt)
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = '加入无限收益 Discord 服务器的邀请链接。'}
CMDs[#CMDs + 1] = {NAME = 'guiscale [数字]', DESC = '更改 GUI 的大小。[数字]可接受小数和整数。最小值为0.4，最大值为2'}
CMDs[#CMDs + 1] = {NAME = 'console', DESC = '打开 Roblox 控制台'}
CMDs[#CMDs + 1] = {NAME = 'oldconsole', DESC = '加载旧版主题的 Roblox 控制台'}
CMDs[#CMDs + 1] = {NAME = 'explorer / dex', DESC = '打开 Chillz 的 Dex++ 浏览器'}
CMDs[#CMDs + 1] = {NAME = 'moondex / mdex', DESC = '打开 Moon 的 Dex 浏览器'}
CMDs[#CMDs + 1] = {NAME = 'remotespy / rspy', DESC = '打开 Cobalt 以拦截进出网络流量'}
CMDs[#CMDs + 1] = {NAME = 'simplespy / sspy', DESC = '打开 Simple Spy V3 以拦截从客户端到服务器的远程呼叫'}
CMDs[#CMDs + 1] = {NAME = 'audiologger / alogger', DESC = '打开 Edge 的音频记录器'}
...
CMDs[#CMDs + 1] = {NAME = 'antiidle / antiafk', DESC = '防止游戏因空闲/挂机而踢出你'}
CMDs[#CMDs + 1] = {NAME = 'datalimit [数字]', DESC = '设置传出 KBPS 限制'}
CMDs[#CMDs + 1] = {NAME = 'replicationlag / backtrack [数字]', DESC = '设置 IncomingReplicationLag'}
CMDs[#CMDs + 1] = {NAME = 'creatorid / creator', DESC = '通知你创建者的 ID'}
CMDs[#CMDs + 1] = {NAME = 'copycreatorid / copycreator', DESC = '将创建者的 ID 复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'setcreatorid / setcreator', DESC = '将你的用户 ID 设置为创建者的 ID'}
CMDs[#CMDs + 1] = {NAME = 'noprompts', DESC = '阻止游戏显示购买/高级提示'}
CMDs[#CMDs + 1] = {NAME = 'showprompts', DESC = '允许游戏再次显示购买/高级提示'}
CMDs[#CMDs + 1] = {NAME = 'enable [inventory/playerlist/chat/reset/emotes/all]', DESC = '切换核心 GUI 项目的可见性'}
CMDs[#CMDs + 1] = {NAME = 'disable [inventory/playerlist/chat/reset/emotes/all]', DESC = '切换核心 GUI 项目的可见性'}
CMDs[#CMDs + 1] = {NAME = 'showguis', DESC = '显示任何不可见的 GUI'}
CMDs[#CMDs + 1] = {NAME = 'unshowguis', DESC = '撤销 showguis'}
CMDs[#CMDs + 1] = {NAME = 'hideguis', DESC = '隐藏 PlayerGui 中的任何 GUI'}
CMDs[#CMDs + 1] = {NAME = 'unhideguis', DESC = '撤销 hideguis'}
CMDs[#CMDs + 1] = {NAME = 'guidelete', DESC = '启用退格键删除 GUI'}
CMDs[#CMDs + 1] = {NAME = 'unguidelete / noguidelete', DESC = '禁用 guidelete'}
CMDs[#CMDs + 1] = {NAME = 'hideiy', DESC = '隐藏主要的 IY GUI'}
CMDs[#CMDs + 1] = {NAME = 'showiy / unhideiy', DESC = '再次显示 IY'}
CMDs[#CMDs + 1] = {NAME = 'keepiy', DESC = '当你通过服务器传送时自动执行 IY'}
CMDs[#CMDs + 1] = {NAME = 'unkeepiy', DESC = '禁用 keepiy'}
CMDs[#CMDs + 1] = {NAME = 'togglekeepiy', DESC = '切换 keepiy'}
CMDs[#CMDs + 1] = {NAME = 'removeads / adblock', DESC = '自动移除广告广告牌'}
CMDs[#CMDs + 1] = {NAME = 'savegame / saveplace', DESC = '使用 saveinstance 保存游戏'}
CMDs[#CMDs + 1] = {NAME = 'clearerror', DESC = '清除游戏踢出你时出现的烦人框和模糊效果'}
CMDs[#CMDs + 1] = {NAME = 'antigameplaypaused', DESC = '清除因网络延迟加载资源时显示的烦人框'}
CMDs[#CMDs + 1] = {NAME = 'unantigameplaypaused', DESC = '禁用 antigameplaypaused'}
...
CMDs[#CMDs + 1] = {NAME = 'record / rec', DESC = '启动 Roblox 录制器'}
CMDs[#CMDs + 1] = {NAME = 'screenshot / scrnshot', DESC = '截取屏幕截图'}
CMDs[#CMDs + 1] = {NAME = 'togglefullscreen / togglefs', DESC = '切换全屏'}
CMDs[#CMDs + 1] = {NAME = 'notify [文本]', DESC = '使用提供的文本向你发送通知'}
CMDs[#CMDs + 1] = {NAME = 'lastcommand / lastcmd', DESC = '执行之前使用的命令'}
CMDs[#CMDs + 1] = {NAME = 'notifyping / ping', DESC = '通知你自己的 Ping 值'}
CMDs[#CMDs + 1] = {NAME = 'norender', DESC = '禁用 3D 渲染以减少客户端 CPU 使用量'}
CMDs[#CMDs + 1] = {NAME = 'render', DESC = '启用 3D 渲染'}
CMDs[#CMDs + 1] = {NAME = 'use2022materials / 2022materials', DESC = '启用 2022 材质纹理'}
CMDs[#CMDs + 1] = {NAME = 'unuse2022materials / un2022materials', DESC = '禁用 2022 材质纹理'}
CMDs[#CMDs + 1] = {NAME = 'alignmentkeys', DESC = '启用左右对齐键（逗号和句号）'}
...
CMDs[#CMDs + 1] = {NAME = 'noclip', DESC = '穿越物体'}
CMDs[#CMDs + 1] = {NAME = 'unnoclip / clip', DESC = '禁用 noclip'}
CMDs[#CMDs + 1] = {NAME = 'fly [速度]', DESC = '让你飞行'}
CMDs[#CMDs + 1] = {NAME = 'unfly', DESC = '禁用飞行'}
CMDs[#CMDs + 1] = {NAME = 'flyspeed [数字]', DESC = '设置飞行速度（默认为 20）'}
CMDs[#CMDs + 1] = {NAME = 'vehiclefly / vfly [速度]', DESC = '让你在载具中飞行'}
CMDs[#CMDs + 1] = {NAME = 'unvehiclefly / unvfly', DESC = '禁用载具飞行'}
CMDs[#CMDs + 1] = {NAME = 'vehicleflyspeed  / vflyspeed [数字]', DESC = '设置载具飞行速度'}
CMDs[#CMDs + 1] = {NAME = 'cframefly / cfly [速度]', DESC = '让你飞行，绕过一些反作弊（在移动端可用）'}
CMDs[#CMDs + 1] = {NAME = 'uncframefly / uncfly', DESC = '禁用 cfly'}
CMDs[#CMDs + 1] = {NAME = 'cframeflyspeed  / cflyspeed [数字]', DESC = '设置 cfly 速度'}
CMDs[#CMDs + 1] = {NAME = 'qefly [true / false]', DESC = '启用或禁用飞行的 Q 和 E 快捷键'}
CMDs[#CMDs + 1] = {NAME = 'vehiclenoclip / vnoclip', DESC = '关闭载具碰撞'}
CMDs[#CMDs + 1] = {NAME = 'vehicleclip / vclip / unvnoclip', DESC = '启用载具碰撞'}
CMDs[#CMDs + 1] = {NAME = 'float /  platform', DESC = '在你脚下生成一个平台，让你漂浮'}
CMDs[#CMDs + 1] = {NAME = 'unfloat / noplatform', DESC = '移除平台'}
CMDs[#CMDs + 1] = {NAME = 'swim', DESC = '让你在空中游泳'}
CMDs[#CMDs + 1] = {NAME = 'unswim / noswim', DESC = '停止在空中游泳'}
CMDs[#CMDs + 1] = {NAME = 'toggleswim', DESC = '切换游泳'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'setwaypoint / swp [名称]', DESC = '在你的位置设置一个路径点'}
CMDs[#CMDs + 1] = {NAME = 'waypointpos / wpp [名称] [X Y Z]', DESC = '使用指定坐标设置一个路径点'}
CMDs[#CMDs + 1] = {NAME = 'waypoints', DESC = '显示当前活动路径点的列表'}
CMDs[#CMDs + 1] = {NAME = 'showwaypoints / showwp', DESC = '显示所有当前设置的路径点'}
CMDs[#CMDs + 1] = {NAME = 'hidewaypoints / hidewp', DESC = '隐藏显示的路径点'}
CMDs[#CMDs + 1] = {NAME = 'waypoint / wp [名称]', DESC = '将玩家传送到一个路径点'}
CMDs[#CMDs + 1] = {NAME = 'tweenwaypoint / twp [名称]', DESC = '将玩家缓动到一个路径点'}
CMDs[#CMDs + 1] = {NAME = 'walktowaypoint / wtwp [名称]', DESC = '让玩家走向一个路径点'}
CMDs[#CMDs + 1] = {NAME = 'deletewaypoint / dwp [名称]', DESC = '删除一个路径点'}
...
CMDs[#CMDs + 1] = {NAME = 'loopgoto [玩家] [距离] [延迟]', DESC = '循环传送到一个玩家'}
CMDs[#CMDs + 1] = {NAME = 'unloopgoto', DESC = '停止传送到一个玩家'}
CMDs[#CMDs + 1] = {NAME = 'pulsetp / ptp [玩家] [秒数]', DESC = '将你传送到一个玩家指定时间'}
CMDs[#CMDs + 1] = {NAME = 'clientbring / cbring [玩家] (客户端)', DESC = '拉取一个玩家'}
CMDs[#CMDs + 1] = {NAME = 'loopbring [玩家] [距离] [延迟] (客户端)', DESC = '循环将玩家拉到你身边（对击杀有用）'}
CMDs[#CMDs + 1] = {NAME = 'unloopbring [玩家]', DESC = '撤销 loopbring'}
CMDs[#CMDs + 1] = {NAME = 'freeze / fr [玩家] (客户端)', DESC = '冻结一个玩家'}
CMDs[#CMDs + 1] = {NAME = 'freezeanims', DESC = '冻结你的动画/暂停你的动画 - 不适用于默认动画'}
CMDs[#CMDs + 1] = {NAME = 'unfreezeanims', DESC = '解冻你的动画/播放你的动画'}
CMDs[#CMDs + 1] = {NAME = 'thaw / unfr [玩家] (客户端)', DESC = '解冻一个玩家'}
CMDs[#CMDs + 1] = {NAME = 'anchor', DESC = '固定你的角色的 RootPart'}
CMDs[#CMDs + 1] = {NAME = 'unanchor', DESC = '解除固定你的角色的 RootPart'}
CMDs[#CMDs + 1] = {NAME = 'tpposition / tppos [X Y Z]', DESC = '将你传送到指定坐标'}
CMDs[#CMDs + 1] = {NAME = 'tweentpposition / ttppos [X Y Z]', DESC = '缓动到坐标（绕过一些反作弊）'}
CMDs[#CMDs + 1] = {NAME = 'offset [X Y Z]', DESC = '将你偏移指定坐标'}
CMDs[#CMDs + 1] = {NAME = 'tweenoffset / toffset [X Y Z]', DESC = '缓动偏移（绕过一些反作弊）'}
CMDs[#CMDs + 1] = {NAME = 'thru [数字]', DESC = '将你传送到角色面向方向前方 [数字] 格'}
CMDs[#CMDs + 1] = {NAME = 'notifyposition / notifypos [玩家]', DESC = '通知你角色的坐标'}
CMDs[#CMDs + 1] = {NAME = 'copyposition / copypos [玩家]', DESC = '将角色的坐标复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'walktoposition / walktopos [X Y Z]', DESC = '让你走向一个坐标'}
CMDs[#CMDs + 1] = {NAME = 'spawnpoint / spawn [延迟]', DESC = '设置你重生的位置'}
CMDs[#CMDs + 1] = {NAME = 'nospawnpoint / nospawn', DESC = '移除你的自定义重生点'}
CMDs[#CMDs + 1] = {NAME = 'flashback / diedtp', DESC = '传送到你上次死亡的地方'}
CMDs[#CMDs + 1] = {NAME = 'walltp', DESC = '传送到你遇到的任何墙壁的上方/上方'}
CMDs[#CMDs + 1] = {NAME = 'nowalltp / unwalltp', DESC = '禁用 walltp'}
CMDs[#CMDs + 1] = {NAME = 'teleporttool / tptool', DESC = '给你一个传送工具'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'logs', DESC = '打开日志 GUI'}
CMDs[#CMDs + 1] = {NAME = 'chatlogs / clogs', DESC = '记录人们的聊天或私信内容'}
CMDs[#CMDs + 1] = {NAME = 'joinlogs / jlogs', DESC = '记录人们加入的时间'}
CMDs[#CMDs + 1] = {NAME = 'chatlogswebhook / logswebhook [URL]', DESC = '设置 Discord webhook 用于聊天日志（不提供 URL 则禁用此功能）'}
CMDs[#CMDs + 1] = {NAME = 'chat / say [文本]', DESC = '让你发送一条聊天消息（可能绕过禁言）'}
CMDs[#CMDs + 1] = {NAME = 'spam [文本]', DESC = '让你刷屏聊天'}
CMDs[#CMDs + 1] = {NAME = 'unspam', DESC = '关闭刷屏'}
CMDs[#CMDs + 1] = {NAME = 'whisper / pm [玩家] [文本]', DESC = '让你向某人发送私信（可能绕过禁言）'}
CMDs[#CMDs + 1] = {NAME = 'pmspam [玩家] [文本]', DESC = '让你刷屏私信某人'}
CMDs[#CMDs + 1] = {NAME = 'unpmspam [玩家]', DESC = '关闭私信刷屏'}
CMDs[#CMDs + 1] = {NAME = 'spamspeed [数字]', DESC = '设置刷屏速度（默认为 1）'}
CMDs[#CMDs + 1] = {NAME = 'bubblechat (客户端)', DESC = '为你的客户端启用泡泡聊天'}
CMDs[#CMDs + 1] = {NAME = 'unbubblechat / nobubblechat', DESC = '禁用 bubblechat 命令'}
CMDs[#CMDs + 1] = {NAME = 'chatwindow', DESC = '为你的客户端启用聊天窗口'}
CMDs[#CMDs + 1] = {NAME = 'unchatwindow / nochatwindow', DESC = '为你的客户端禁用聊天窗口'}
CMDs[#CMDs + 1] = {NAME = 'darkchat', DESC = '为你的客户端将聊天窗口变为深色'}
CMDs[#CMDs + 1] = {NAME = 'listento [玩家]', DESC = '监听一个玩家周围的区域。也可以通过 VC 偷听'}
CMDs[#CMDs + 1] = {NAME = 'unlistento', DESC = '禁用 listento'}
CMDs[#CMDs + 1] = {NAME = 'muteallvoices / muteallvcs', DESC = '静音所有玩家的语音聊天'}
CMDs[#CMDs + 1] = {NAME = 'unmuteallvoices / unmuteallvcs', DESC = '取消静音所有玩家的语音聊天'}
CMDs[#CMDs + 1] = {NAME = 'mutevc [玩家]', DESC = '静音一个玩家的语音聊天'}
CMDs[#CMDs + 1] = {NAME = 'unmutevc [玩家]', DESC = '取消静音一个玩家的语音聊天'}
CMDs[#CMDs + 1] = {NAME = 'phonebook / call', DESC = '弹出 Roblox 通讯录 UI，让你给你的好友打电话。需要启用语音聊天'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'esp', DESC = '查看所有玩家及其状态'}
CMDs[#CMDs + 1] = {NAME = 'espteam', DESC = 'ESP 但队友为绿色，敌人为红色'}
CMDs[#CMDs + 1] = {NAME = 'noesp / unesp / unespteam', DESC = '移除 ESP'}
CMDs[#CMDs + 1] = {NAME = 'esptransparency [数字]', DESC = '更改 ESP 相关命令的透明度'}
CMDs[#CMDs + 1] = {NAME = 'partesp [部件名称]', DESC = '高亮一个部件'}
CMDs[#CMDs + 1] = {NAME = 'unpartesp / nopartesp [部件名称]', DESC = '移除 partesp'}
CMDs[#CMDs + 1] = {NAME = 'chams', DESC = 'ESP 但没有文本遮挡'}
CMDs[#CMDs + 1] = {NAME = 'nochams / unchams', DESC = '移除 chams'}
CMDs[#CMDs + 1] = {NAME = 'locate [玩家]', DESC = '查看单个玩家及其状态'}
CMDs[#CMDs + 1] = {NAME = 'unlocate / nolocate [玩家]', DESC = '移除 locate'}
CMDs[#CMDs + 1] = {NAME = 'xray', DESC = '使 workspace 中的所有部件透明'}
CMDs[#CMDs + 1] = {NAME = 'unxray / noxray', DESC = '恢复 workspace 中所有部件的不透明度'}
CMDs[#CMDs + 1] = {NAME = 'loopxray', DESC = '使 workspace 中的所有部件透明但循环执行'}
CMDs[#CMDs + 1] = {NAME = 'unloopxray', DESC = '取消循环 xray'}
CMDs[#CMDs + 1] = {NAME = 'togglexray', DESC = '切换 xray'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'spectate / view [玩家]', DESC = '旁观一个玩家'}
CMDs[#CMDs + 1] = {NAME = 'viewpart / viewp [部件名称]', DESC = '查看一个部件'}
CMDs[#CMDs + 1] = {NAME = 'unspectate / unview', DESC = '停止旁观玩家'}
CMDs[#CMDs + 1] = {NAME = 'freecam / fc', DESC = '允许你自由移动相机在游戏中'}
CMDs[#CMDs + 1] = {NAME = 'freecampos / fcpos [X Y Z]', DESC = '将自由相机移动到特定位置/在特定位置打开'}
CMDs[#CMDs + 1] = {NAME = 'freecamwaypoint / fcwp [名称]', DESC = '将自由相机移动到路径点/在路径点打开'}
CMDs[#CMDs + 1] = {NAME = 'freecamgoto / fcgoto / fctp [玩家]', DESC = '将自由相机移动到玩家/在玩家位置打开'}
CMDs[#CMDs + 1] = {NAME = 'unfreecam / unfc', DESC = '禁用自由相机'}
CMDs[#CMDs + 1] = {NAME = 'freecamspeed / fcspeed [数字]', DESC = '调整自由相机速度（默认为 1）'}
CMDs[#CMDs + 1] = {NAME = 'notifyfreecamposition / notifyfcpos', DESC = '通知你自由相机的坐标'}
CMDs[#CMDs + 1] = {NAME = 'copyfreecamposition / copyfcpos', DESC = '将自由相机的坐标复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'gotocamera / gotocam', DESC = '将你传送到相机所在位置'}
CMDs[#CMDs + 1] = {NAME = 'tweengotocam / tgotocam', DESC = '将你缓动到相机所在位置'}
CMDs[#CMDs + 1] = {NAME = 'firstp', DESC = '强制相机进入第一人称'}
CMDs[#CMDs + 1] = {NAME = 'thirdp', DESC = '允许相机进入第三人称'}
CMDs[#CMDs + 1] = {NAME = 'noclipcam / nccam', DESC = '允许相机穿越物体，如墙壁'}
CMDs[#CMDs + 1] = {NAME = 'maxzoom [数字]', DESC = '最大相机缩放'}
CMDs[#CMDs + 1] = {NAME = 'minzoom [数字]', DESC = '最小相机缩放'}
CMDs[#CMDs + 1] = {NAME = 'camdistance [数字]', DESC = '更改相机与玩家的距离'}
CMDs[#CMDs + 1] = {NAME = 'fov [数字]', DESC = '调整视野（默认为 70）'}
CMDs[#CMDs + 1] = {NAME = 'fixcam / restorecam', DESC = '修复相机'}
CMDs[#CMDs + 1] = {NAME = 'enableshiftlock / enablesl', DESC = '启用 Shift Lock 选项'}
CMDs[#CMDs + 1] = {NAME = 'lookat [玩家]', DESC = '将相机视角移动到玩家'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'btools (客户端)', DESC = '给你建筑工具（不会同步）'}
CMDs[#CMDs + 1] = {NAME = 'f3x (客户端)', DESC = '给你 F3X 建筑工具（不会同步）'}
CMDs[#CMDs + 1] = {NAME = 'partname / partpath', DESC = '允许你点击一个部件查看其路径和名称'}
CMDs[#CMDs + 1] = {NAME = 'delete [实例名称] (客户端)', DESC = '从 workspace 中移除所有具有特定名称的部件（不会同步）'}
CMDs[#CMDs + 1] = {NAME = 'deleteclass / dc [类名称] (客户端)', DESC = '从 workspace 中移除所有具有特定类名的部件（不会同步）'}
CMDs[#CMDs + 1] = {NAME = 'lockworkspace / lockws', DESC = '锁定整个 workspace'}
CMDs[#CMDs + 1] = {NAME = 'unlockworkspace / unlockws', DESC = '解锁整个 workspace'}
CMDs[#CMDs + 1] = {NAME = 'invisibleparts / invisparts (客户端)', DESC = '显示不可见的部件'}
CMDs[#CMDs + 1] = {NAME = 'uninvisibleparts / uninvisparts (客户端)', DESC = '使受 invisparts 影响的部件恢复正常'}
CMDs[#CMDs + 1] = {NAME = 'deleteinvisparts / dip (客户端)', DESC = '删除不可见部件'}
CMDs[#CMDs + 1] = {NAME = 'gotopart [部件名称]', DESC = '将你的角色移动到部件或多个部件'}
CMDs[#CMDs + 1] = {NAME = 'tweengotopart / tgotopart [部件名称]', DESC = '将你的角色缓动到部件或多个部件'}
CMDs[#CMDs + 1] = {NAME = 'gotopartclass / gpc [类名称]', DESC = '将你的角色移动到具有特定类名的部件或多个部件'}
CMDs[#CMDs + 1] = {NAME = 'tweengotopartclass / tgpc [类名称]', DESC = '将你的角色缓动到具有特定类名的部件或多个部件'}
CMDs[#CMDs + 1] = {NAME = 'gotomodel [部件名称]', DESC = '将你的角色移动到模型或多个模型'}
CMDs[#CMDs + 1] = {NAME = 'tweengotomodel / tgotomodel [部件名称]', DESC = '将你的角色缓动到模型或多个模型'}
CMDs[#CMDs + 1] = {NAME = 'gotopartdelay / gotomodeldelay [数字]', DESC = '调整你传送到每个部件的速度（默认为 0.1）'}
CMDs[#CMDs + 1] = {NAME = 'bringpart [部件名称] (客户端)', DESC = '将部件或多个部件移动到你的角色位置'}
CMDs[#CMDs + 1] = {NAME = 'bringpartclass / bpc [类名称] (客户端)', DESC = '将具有特定类名的部件或多个部件移动到你的角色位置'}
CMDs[#CMDs + 1] = {NAME = 'noclickdetectorlimits / nocdlimits', DESC = '将所有点击检测器的 MaxActivationDistance 设置为 math.huge'}
CMDs[#CMDs + 1] = {NAME = 'fireclickdetectors / firecd [名称]', DESC = '触发游戏中的所有点击检测器，或使用可选名称过滤'}
CMDs[#CMDs + 1] = {NAME = 'firetouchinterests / touchinterests [名称]', DESC = '触发游戏中的所有触摸交互，或使用可选名称过滤'}
CMDs[#CMDs + 1] = {NAME = 'noproximitypromptlimits / nopplimits', DESC = '将所有近距离提示的 MaxActivationDistance 设置为 math.huge'}
CMDs[#CMDs + 1] = {NAME = 'fireproximityprompts / firepp [名称]', DESC = '触发游戏中的所有近距离提示，或使用可选名称过滤'}
CMDs[#CMDs + 1] = {NAME = 'instantproximityprompts / instantpp', DESC = '禁用近距离提示的冷却时间'}
CMDs[#CMDs + 1] = {NAME = 'uninstantproximityprompts / uninstantpp', DESC = '撤销冷却时间移除'}
CMDs[#CMDs + 1] = {NAME = 'tpunanchored / tpua [玩家]', DESC = '将未固定的部件传送到一个玩家'}
CMDs[#CMDs + 1] = {NAME = 'animsunanchored / freezeua', DESC = '冻结未固定的部件'}
CMDs[#CMDs + 1] = {NAME = 'thawunanchored / thawua / unfreezeua', DESC = '解冻未固定的部件'}
CMDs[#CMDs + 1] = {NAME = 'removeterrain / rterrain / noterrain', DESC = '移除所有地形'}
CMDs[#CMDs + 1] = {NAME = 'clearnilinstances / nonilinstances / cni', DESC = '移除 nil 实例'}
CMDs[#CMDs + 1] = {NAME = 'destroyheight / dh [数字]', DESC = '设置 FallenPartsDestroyHeight'}
CMDs[#CMDs + 1] = {NAME = 'fakeout', DESC = '传送至虚空然后返回（对击杀附在你身上的人有用）'}
CMDs[#CMDs + 1] = {NAME = 'antivoid', DESC = '通过向上发射你来防止你掉入虚空'}
CMDs[#CMDs + 1] = {NAME = 'unantivoid / noantivoid', DESC = '禁用 antivoid'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'fullbright / fb (客户端)', DESC = '使地图更亮/更可见'}
CMDs[#CMDs + 1] = {NAME = 'loopfullbright / loopfb (客户端)', DESC = '使地图更亮/更可见但循环执行'}
CMDs[#CMDs + 1] = {NAME = 'unloopfullbright / unloopfb', DESC = '取消循环 fullbright'}
CMDs[#CMDs + 1] = {NAME = 'ambient [数字] [数字] [数字] (客户端)', DESC = '更改环境光'}
CMDs[#CMDs + 1] = {NAME = 'day (客户端)', DESC = '将客户端时间更改为白天'}
CMDs[#CMDs + 1] = {NAME = 'night (客户端)', DESC = '将客户端时间更改为夜晚'}
CMDs[#CMDs + 1] = {NAME = 'nofog (客户端)', DESC = '移除雾效'}
CMDs[#CMDs + 1] = {NAME = 'brightness [数字] (客户端)', DESC = '更改亮度照明属性'}
CMDs[#CMDs + 1] = {NAME = 'globalshadows / gshadows (客户端)', DESC = '启用全局阴影'}
CMDs[#CMDs + 1] = {NAME = 'noglobalshadows / nogshadows (客户端)', DESC = '禁用全局阴影'}
CMDs[#CMDs + 1] = {NAME = 'restorelighting / rlighting', DESC = '恢复照明属性'}
CMDs[#CMDs + 1] = {NAME = 'light [半径] [亮度] (客户端)', DESC = '给你的玩家提供动态光'}
CMDs[#CMDs + 1] = {NAME = 'nolight / unlight', DESC = '从你的玩家身上移除动态光'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'inspect / examine [玩家]', DESC = '为特定玩家打开检查菜单'}
CMDs[#CMDs + 1] = {NAME = 'age [玩家]', DESC = '告诉你玩家的年龄'}
CMDs[#CMDs + 1] = {NAME = 'chatage [玩家]', DESC = '在聊天中发送玩家的年龄'}
CMDs[#CMDs + 1] = {NAME = 'joindate / jd [玩家]', DESC = '告诉你玩家加入 Roblox 的日期'}
CMDs[#CMDs + 1] = {NAME = 'chatjoindate / cjd [玩家]', DESC = '在聊天中发送玩家加入 Roblox 的日期'}
CMDs[#CMDs + 1] = {NAME = 'copyname / copyuser [玩家]', DESC = '将玩家的完整用户名复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'userid / id [玩家]', DESC = '通知玩家的用户 ID'}
CMDs[#CMDs + 1] = {NAME = 'copyplaceid / placeid', DESC = '将当前地点 ID 复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'copygameid / gameid', DESC = '将当前游戏 ID 复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'copyuserid / copyid [玩家]', DESC = '将玩家的用户 ID 复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'appearanceid / aid [玩家]', DESC = '通知玩家的外观 ID'}
CMDs[#CMDs + 1] = {NAME = 'copyappearanceid / caid [玩家]', DESC = '将玩家的外观 ID 复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'bang [玩家] [速度]', DESC = 'owo'}
CMDs[#CMDs + 1] = {NAME = 'unbang', DESC = 'uwu'}
CMDs[#CMDs + 1] = {NAME = 'jerk', DESC = '让你打...'}
CMDs[#CMDs + 1] = {NAME = 'scare / spook [玩家]', DESC = '在玩家面前闪现半秒钟'}
CMDs[#CMDs + 1] = {NAME = 'carpet [玩家]', DESC = '做某人的地毯'}
CMDs[#CMDs + 1] = {NAME = 'uncarpet', DESC = '撤销 carpet'}
CMDs[#CMDs + 1] = {NAME = 'friend [玩家]', DESC = '向某些玩家发送好友请求'}
CMDs[#CMDs + 1] = {NAME = 'unfriend [玩家]', DESC = '与某些玩家解除好友关系'}
CMDs[#CMDs + 1] = {NAME = 'headsit [玩家]', DESC = '坐在玩家的头上'}
CMDs[#CMDs + 1] = {NAME = 'walkto / follow [玩家]', DESC = '跟随一个玩家'}
CMDs[#CMDs + 1] = {NAME = 'pathfindwalkto / pathfindfollow [玩家]', DESC = '使用寻路跟随一个玩家'}
CMDs[#CMDs + 1] = {NAME = 'pathfindwalktowaypoint / pathfindwalktowp [路径点]', DESC = '使用寻路走向一个路径点'}
CMDs[#CMDs + 1] = {NAME = 'unwalkto / unfollow', DESC = '停止跟随一个玩家'}
CMDs[#CMDs + 1] = {NAME = 'orbit [玩家] [速度] [距离]', DESC = '让你的角色围绕一个玩家旋转，可选速度和距离'}
CMDs[#CMDs + 1] = {NAME = 'unorbit', DESC = '禁用 orbit'}
CMDs[#CMDs + 1] = {NAME = 'stareat / stare [玩家]', DESC = '盯/看一个玩家'}
CMDs[#CMDs + 1] = {NAME = 'unstareat / unstare [玩家]', DESC = '禁用 stareat'}
CMDs[#CMDs + 1] = {NAME = 'rolewatch [群组ID] [角色名称]', DESC = '当被监视群组的某人加入服务器时通知'}
CMDs[#CMDs + 1] = {NAME = 'rolewatchstop / unrolewatch', DESC = '禁用 Rolewatch'}
CMDs[#CMDs + 1] = {NAME = 'rolewatchleave', DESC = '切换是否在被监视群组的人加入时离开游戏'}
CMDs[#CMDs + 1] = {NAME = 'staffwatch', DESC = '当游戏的工作人员加入服务器时通知'}
CMDs[#CMDs + 1] = {NAME = 'unstaffwatch', DESC = '禁用 Staffwatch'}
CMDs[#CMDs + 1] = {NAME = 'findfriendgroups', DESC = '通知你是否有玩家彼此是好友'}
CMDs[#CMDs + 1] = {NAME = 'handlekill / hkill [玩家] [半径] (工具)', DESC = '使用工具伤害击杀一个玩家（你需要一个工具）'}
CMDs[#CMDs + 1] = {NAME = 'fling', DESC = '击飞你触碰到的任何人'}
CMDs[#CMDs + 1] = {NAME = 'unfling', DESC = '禁用 fling 命令'}
CMDs[#CMDs + 1] = {NAME = 'flyfling [速度]', DESC = '基本上是隐形击飞命令但不隐形'}
CMDs[#CMDs + 1] = {NAME = 'unflyfling', DESC = '禁用 flyfling 命令'}
CMDs[#CMDs + 1] = {NAME = 'walkfling', DESC = '基本上是击飞但不旋转'}
CMDs[#CMDs + 1] = {NAME = 'unwalkfling / nowalkfling', DESC = '禁用 walkfling'}
CMDs[#CMDs + 1] = {NAME = 'invisfling', DESC = '启用隐形击飞（隐形部分已被修复，先试试 god 命令再使用这个）'}
CMDs[#CMDs + 1] = {NAME = 'antifling', DESC = '禁用玩家碰撞以防止你被击飞'}
CMDs[#CMDs + 1] = {NAME = 'unantifling', DESC = '禁用 antifling'}
CMDs[#CMDs + 1] = {NAME = 'loopoof', DESC = '循环所有人的角色声音（所有人都能听到）'}
CMDs[#CMDs + 1] = {NAME = 'unloopoof', DESC = '停止 oof 混乱'}
CMDs[#CMDs + 1] = {NAME = 'muteboombox [玩家]', DESC = '静音某人的音箱'}
CMDs[#CMDs + 1] = {NAME = 'unmuteboombox [玩家]', DESC = '取消静音某人的音箱'}
CMDs[#CMDs + 1] = {NAME = 'hitboxes', DESC = '显示所有碰撞箱'}
CMDs[#CMDs + 1] = {NAME = 'unhitboxes', DESC = '停止显示所有碰撞箱'}
CMDs[#CMDs + 1] = {NAME = 'hitbox [玩家] [大小] [透明度]', DESC = '扩展玩家的 HumanoidRootPart 的碰撞箱（默认为 1）'}
CMDs[#CMDs + 1] = {NAME = 'headsize [玩家] [大小]', DESC = '扩展玩家的 Head 的大小（默认为 1）'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'reset', DESC = '正常重置你的角色'}
CMDs[#CMDs + 1] = {NAME = 'respawn', DESC = '重生你'}
CMDs[#CMDs + 1] = {NAME = 'refresh / re', DESC = '重生并将你带回相同位置'}
CMDs[#CMDs + 1] = {NAME = 'god', DESC = '使你的角色在大多数游戏中难以被击杀'}
CMDs[#CMDs + 1] = {NAME = 'invisible / invis', DESC = '使其他玩家看不到你'}
CMDs[#CMDs + 1] = {NAME = 'visible / vis', DESC = '使其他玩家能看到你'}
CMDs[#CMDs + 1] = {NAME = 'toolinvisible / toolinvis / tinvis', DESC = '使其他玩家看不到你，且可以使用工具'}
CMDs[#CMDs + 1] = {NAME = 'speed / ws / walkspeed [数字]', DESC = '更改你的移速（默认为 16）'}
CMDs[#CMDs + 1] = {NAME = 'spoofspeed / spoofws [数字]', DESC = '在客户端上伪造你的 WalkSpeed'}
CMDs[#CMDs + 1] = {NAME = 'loopspeed / loopws [数字]', DESC = '循环你的移速'}
CMDs[#CMDs + 1] = {NAME = 'unloopspeed / unloopws', DESC = '关闭 loopspeed'}
CMDs[#CMDs + 1] = {NAME = 'hipheight / hheight [数字]', DESC = '调整臀部高度'}
CMDs[#CMDs + 1] = {NAME = 'jumppower / jpower / jp [数字]', DESC = '更改玩家的跳跃高度（默认为 50）'}
CMDs[#CMDs + 1] = {NAME = 'spoofjumppower / spoofjp [数字]', DESC = '在客户端上伪造你的 JumpPower'}
CMDs[#CMDs + 1] = {NAME = 'loopjumppower / loopjp [数字]', DESC = '循环你的跳跃高度'}
CMDs[#CMDs + 1] = {NAME = 'unloopjumppower / unloopjp', DESC = '关闭 loopjumppower'}
CMDs[#CMDs + 1] = {NAME = 'maxslopeangle / msa [数字]', DESC = '调整 MaxSlopeAngle'}
CMDs[#CMDs + 1] = {NAME = 'gravity / grav [数字] (客户端)', DESC = '更改你的重力'}
CMDs[#CMDs + 1] = {NAME = 'sit', DESC = '让你的角色坐下'}
CMDs[#CMDs + 1] = {NAME = 'lay / laydown', DESC = '让你的角色躺下'}
CMDs[#CMDs + 1] = {NAME = 'sitwalk', DESC = '让你的角色坐着同时还能行走'}
CMDs[#CMDs + 1] = {NAME = 'nosit', DESC = '阻止你的角色坐下'}
CMDs[#CMDs + 1] = {NAME = 'unnosit', DESC = '禁用 nosit'}
CMDs[#CMDs + 1] = {NAME = 'jump', DESC = '让你的角色跳跃'}
CMDs[#CMDs + 1] = {NAME = 'infinitejump / infjump', DESC = '允许你在落地前跳跃'}
CMDs[#CMDs + 1] = {NAME = 'uninfinitejump / uninfjump', DESC = '禁用 infjump'}
CMDs[#CMDs + 1] = {NAME = 'flyjump', DESC = '允许你按住空格向上飞'}
CMDs[#CMDs + 1] = {NAME = 'unflyjump', DESC = '禁用 flyjump'}
CMDs[#CMDs + 1] = {NAME = 'autojump / ajump', DESC = '当你撞到物体时自动跳跃'}
CMDs[#CMDs + 1] = {NAME = 'unautojump / unajump', DESC = '禁用 autojump'}
CMDs[#CMDs + 1] = {NAME = 'edgejump / ejump', DESC = '当你到达物体边缘时自动跳跃'}
CMDs[#CMDs + 1] = {NAME = 'unedgejump / unejump', DESC = '禁用 edgejump'}
CMDs[#CMDs + 1] = {NAME = 'platformstand / stun', DESC = '启用 PlatformStand'}
CMDs[#CMDs + 1] = {NAME = 'unplatformstand / unstun', DESC = '禁用 PlatformStand'}
CMDs[#CMDs + 1] = {NAME = 'norotate / noautorotate', DESC = '禁用 AutoRotate'}
CMDs[#CMDs + 1] = {NAME = 'unnorotate / autorotate', DESC = '启用 AutoRotate'}
CMDs[#CMDs + 1] = {NAME = 'enablestate [StateType]', DESC = '启用人形状态类型'}
CMDs[#CMDs + 1] = {NAME = 'disablestate [StateType]', DESC = '禁用人形状态类型'}
CMDs[#CMDs + 1] = {NAME = 'team [队伍名称] (客户端)', DESC = '更改你的队伍。有时可以欺骗本地脚本。'}
CMDs[#CMDs + 1] = {NAME = 'nobillboardgui / nobgui / noname', DESC = '从你的玩家身上移除 Billboard 和 Surface GUI（例如咖啡馆的名称 GUI）'}
CMDs[#CMDs + 1] = {NAME = 'loopnobgui / loopnoname', DESC = '循环从你的玩家身上移除 Billboard 和 Surface GUI（例如咖啡馆的名称 GUI）'}
CMDs[#CMDs + 1] = {NAME = 'unloopnobgui / unloopnoname', DESC = '禁用 loopnobgui'}
CMDs[#CMDs + 1] = {NAME = 'noarms', DESC = '移除你的手臂'}
CMDs[#CMDs + 1] = {NAME = 'nolegs', DESC = '移除你的腿'}
CMDs[#CMDs + 1] = {NAME = 'nolimbs', DESC = '移除你的四肢'}
CMDs[#CMDs + 1] = {NAME = 'naked (客户端)', DESC = '移除你的服装'}
CMDs[#CMDs + 1] = {NAME = 'noface / removeface', DESC = '移除你的脸'}
CMDs[#CMDs + 1] = {NAME = 'blockhead', DESC = '将你的头变成方块'}
CMDs[#CMDs + 1] = {NAME = 'blockhats', DESC = '将你的帽子变成方块'}
CMDs[#CMDs + 1] = {NAME = 'blocktool', DESC = '将当前选中的工具变成方块'}
CMDs[#CMDs + 1] = {NAME = 'creeper', DESC = '让你看起来像苦力怕'}
CMDs[#CMDs + 1] = {NAME = 'drophats', DESC = '扔掉你的帽子'}
CMDs[#CMDs + 1] = {NAME = 'nohats / deletehats / rhats', DESC = '删除你的帽子'}
CMDs[#CMDs + 1] = {NAME = 'hatspin / spinhats', DESC = '旋转你角色的配饰'}
CMDs[#CMDs + 1] = {NAME = 'unhatspin / unspinhats', DESC = '撤销 spinhats'}
CMDs[#CMDs + 1] = {NAME = 'clearhats / cleanhats', DESC = '清理 workspace 中的帽子'}
CMDs[#CMDs + 1] = {NAME = 'chardelete / cd [实例名称]', DESC = '从你的角色中移除所有具有特定名称的部件'}
CMDs[#CMDs + 1] = {NAME = 'chardeleteclass / cdc [类名称]', DESC = '从你的角色中移除所有具有特定类名的部件'}
CMDs[#CMDs + 1] = {NAME = 'deletevelocity / dv / removeforces', DESC = '移除你角色中的所有速度/力实例'}
CMDs[#CMDs + 1] = {NAME = 'weaken [数字]', DESC = '降低你的角色密度'}
CMDs[#CMDs + 1] = {NAME = 'unweaken', DESC = '将你的角色的 CustomPhysicalProperties 设置为默认值'}
CMDs[#CMDs + 1] = {NAME = 'strengthen [数字]', DESC = '增加你的角色密度（CustomPhysicalProperties）'}
CMDs[#CMDs + 1] = {NAME = 'unstrengthen', DESC = '将你的角色的 CustomPhysicalProperties 设置为默认值'}
CMDs[#CMDs + 1] = {NAME = 'breakvelocity', DESC = '将你的角色速度设为 0'}
CMDs[#CMDs + 1] = {NAME = 'spin [速度]', DESC = '旋转你的角色'}
CMDs[#CMDs + 1] = {NAME = 'unspin', DESC = '禁用 spin'}
CMDs[#CMDs + 1] = {NAME = 'split', DESC = '将你的角色从中间分开'}
CMDs[#CMDs + 1] = {NAME = 'nilchar', DESC = '将你的角色的父级设为 nil'}
CMDs[#CMDs + 1] = {NAME = 'unnilchar / nonilchar', DESC = '将你的角色的父级设为 workspace'}
CMDs[#CMDs + 1] = {NAME = 'noroot / removeroot / rroot', DESC = '移除你的角色的 HumanoidRootPart'}
CMDs[#CMDs + 1] = {NAME = 'replaceroot', DESC = '替换你的角色的 HumanoidRootPart'}
CMDs[#CMDs + 1] = {NAME = 'clearcharappearance / clearchar / clrchar', DESC = '移除所有配饰、衬衫、裤子、角色网格和身体颜色'}
CMDs[#CMDs + 1] = {NAME = 'tpwalk / teleportwalk [数字]', DESC = '将你传送到移动方向'}
CMDs[#CMDs + 1] = {NAME = 'untpwalk / unteleportwalk', DESC = '撤销 tpwalk / teleportwalk'}
CMDs[#CMDs + 1] = {NAME = 'trip', DESC = '让你的角色摔倒'}
CMDs[#CMDs + 1] = {NAME = 'wallwalk / walkonwalls', DESC = '在墙上行走'}
CMDs[#CMDs + 1] = {NAME = 'promptr6', DESC = '提示游戏将你的角色类型切换为 R6'}
CMDs[#CMDs + 1] = {NAME = 'promptr15', DESC = '提示游戏将你的角色类型切换为 R15'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'animation / anim [ID] [速度]', DESC = '让你的角色执行一个动画（必须是市场或 Roblox/stickmasterluke 的动画才能同步）'}
CMDs[#CMDs + 1] = {NAME = 'emote / em [ID] [速度]', DESC = '让你的角色执行一个表情（必须是市场或 Roblox/stickmasterluke 的动画才能同步）'}
CMDs[#CMDs + 1] = {NAME = 'dance', DESC = '让你跳舞'}
CMDs[#CMDs + 1] = {NAME = 'undance', DESC = '停止舞蹈动画'}
CMDs[#CMDs + 1] = {NAME = 'spasm', DESC = '让你抽搐'}
CMDs[#CMDs + 1] = {NAME = 'unspasm', DESC = '停止抽搐'}
CMDs[#CMDs + 1] = {NAME = 'headthrow', DESC = '简单地让你的头甩出去'}
CMDs[#CMDs + 1] = {NAME = 'noanim', DESC = '禁用你的动画'}
CMDs[#CMDs + 1] = {NAME = 'reanim', DESC = '恢复你的动画'}
CMDs[#CMDs + 1] = {NAME = 'animspeed [数字]', DESC = '更改当前动画的速度'}
CMDs[#CMDs + 1] = {NAME = 'copyanimation / copyanim / copyemote [玩家]', DESC = '复制别人的动画'}
CMDs[#CMDs + 1] = {NAME = 'copyanimationid / copyanimid / copyemoteid [玩家]', DESC = '将你的动画 ID 或别人的动画 ID 复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'loopanimation / loopanim', DESC = '循环你当前的动画'}
CMDs[#CMDs + 1] = {NAME = 'stopanimations / stopanims', DESC = '停止正在运行的动画'}
CMDs[#CMDs + 1] = {NAME = 'refreshanimations / refreshanims', DESC = '刷新动画'}
CMDs[#CMDs + 1] = {NAME = 'allowcustomanim / allowcustomanimations', DESC = '允许你使用自定义动画包代替'}
CMDs[#CMDs + 1] = {NAME = 'unallowcustomanim / unallowcustomanimations', DESC = '不允许你使用自定义动画包代替'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'autoclick [点击延迟] [释放延迟]', DESC = '以设定延迟自动点击鼠标'}
CMDs[#CMDs + 1] = {NAME = 'unautoclick / noautoclick', DESC = '关闭 autoclick'}
CMDs[#CMDs + 1] = {NAME = 'autokeypress [按键] [按下延迟] [释放延迟]', DESC = '以设定延迟自动按下按键'}
CMDs[#CMDs + 1] = {NAME = 'unautokeypress', DESC = '停止 autokeypress'}
CMDs[#CMDs + 1] = {NAME = 'hovername', DESC = '当鼠标悬停在玩家身上时显示用户名'}
CMDs[#CMDs + 1] = {NAME = 'unhovername / nohovername', DESC = '关闭 hovername'}
CMDs[#CMDs + 1] = {NAME = 'mousesensitivity / ms [0-10]', DESC = '设置鼠标灵敏度（影响第一人称和右键拖动）（默认为 1）'}
CMDs[#CMDs + 1] = {NAME = 'clickdelete', DESC = '前往 设置 > 快捷键 > 添加 设置点击删除'}
CMDs[#CMDs + 1] = {NAME = 'clickteleport', DESC = '前往 设置 > 快捷键 > 添加 设置点击传送'}
CMDs[#CMDs + 1] = {NAME = 'mouseteleport / mousetp', DESC = '将你的角色传送到鼠标位置。建议作为快捷键使用'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'tools', DESC = '从 ReplicatedStorage 和 Lighting 复制工具'}
CMDs[#CMDs + 1] = {NAME = 'notools / removetools / deletetools', DESC = '从角色和背包中移除工具'}
CMDs[#CMDs + 1] = {NAME = 'deleteselectedtool / dst', DESC = '移除任何当前选中的工具'}
CMDs[#CMDs + 1] = {NAME = 'grabtools', DESC = '自动获取掉落的工具'}
CMDs[#CMDs + 1] = {NAME = 'ungrabtools / nograbtools', DESC = '禁用 grabtools'}
CMDs[#CMDs + 1] = {NAME = 'copytools [玩家] (客户端)', DESC = '复制玩家的工具'}
CMDs[#CMDs + 1] = {NAME = 'dupetools / clonetools [数字]', DESC = '复制你的库存工具指定次数'}
CMDs[#CMDs + 1] = {NAME = 'droptools', DESC = '放下你的工具'}
CMDs[#CMDs + 1] = {NAME = 'droppabletools', DESC = '使你的工具可掉落'}
CMDs[#CMDs + 1] = {NAME = 'equiptools', DESC = '一次装备你库存中的所有工具'}
CMDs[#CMDs + 1] = {NAME = 'unequiptools', DESC = '一次卸下你当前持有的所有工具'}
CMDs[#CMDs + 1] = {NAME = 'removespecifictool [名称]', DESC = '自动从你的库存中移除特定工具'}
CMDs[#CMDs + 1] = {NAME = 'unremovespecifictool [名称]', DESC = '停止从你的库存中移除特定工具'}
CMDs[#CMDs + 1] = {NAME = 'clearremovespecifictool', DESC = '停止从你的库存中移除所有特定工具'}
CMDs[#CMDs + 1] = {NAME = 'reach [数字]', DESC = '增加你持有的工具的碰撞箱'}
CMDs[#CMDs + 1] = {NAME = 'boxreach [数字]', DESC = '以方框形状增加你持有的工具的碰撞箱'}
CMDs[#CMDs + 1] = {NAME = 'unreach / noreach', DESC = '关闭 reach'}
CMDs[#CMDs + 1] = {NAME = 'grippos [X Y Z]', DESC = '更改当前工具的握持位置'}
CMDs[#CMDs + 1] = {NAME = 'usetools [数量] [延迟]', DESC = '同时激活背包中的所有工具'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'addalias [命令] [别名]', DESC = '为命令添加一个别名'}
CMDs[#CMDs + 1] = {NAME = 'removealias [别名]', DESC = '移除自定义别名'}
CMDs[#CMDs + 1] = {NAME = 'clraliases', DESC = '移除所有自定义别名'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'addplugin / plugin [名称]', DESC = '通过命令添加插件'}
CMDs[#CMDs + 1] = {NAME = 'removeplugin / deleteplugin [名称]', DESC = '通过命令移除插件'}
CMDs[#CMDs + 1] = {NAME = 'reloadplugin [名称]', DESC = '重新加载插件'}
CMDs[#CMDs + 1] = {NAME = 'addallplugins / loadallplugins', DESC = '从 workspace 文件夹中添加所有可用插件'}
				...
				local function espLoop()
					if COREGUI:FindFirstChild(plr.Name..'_ESP') then
						if plr.Character and getRoot(plr.Character) and plr.Character:FindFirstChildOfClass("Humanoid") and Players.LocalPlayer.Character and getRoot(Players.LocalPlayer.Character) and Players.LocalPlayer.Character:FindFirstChildOfClass("Humanoid") then
							...
							TextLabel.Text = '名称: '..plr.Name..' | 生命值: '..round(plr.Character:FindFirstChildOfClass('Humanoid').Health, 1)..' | 距离: '..pos
						end
					else
						teamChange:Disconnect()
						addedFunc:Disconnect()
	...
	if Holder_2 then
		...
		for i = 1, #binds do
			...
			if binds[i].TOGGLE then
				...
				newbind.Text.Text = key.." > "..binds[i].COMMAND.."  "..(binds[i].ISKEYUP and "(松开)" or "(按下)")
			end
...
function unkeybind(cmd,key)
	...
	if key == 'RightClick' or key == 'LeftClick' then
		notify('快捷键已更新','已解除绑定 '..key..' 到 '..cmd)
	else
		notify('快捷键已更新','已解除绑定 '..key:sub(14)..' 到 '..cmd)
	end
end
...
BindTriggerSelect.MouseButton1Click:Connect(function()
	...
	BindTriggerSelect.Text = bindChosenKeyUp and "松开" or "按下"
end)
...
Add_2.MouseButton1Click:Connect(function()
	if keySelected then
		if string.find(Cmdbar_2.Text, "\\\\") or string.find(Cmdbar_3.Text, "\\\\") then
			notify('快捷键错误','只能使用一个反斜杠将多个命令绑定到一个快捷键或命令中')
		else
			...
			if keyPressed == 'RightClick' or keyPressed == 'LeftClick' then
				notify('快捷键已更新','已绑定 '..keyPressed..' 到 '..Cmdbar_2.Text..(newToggle and " / "..Cmdbar_3.Text or ""))
			else
				notify('快捷键已更新','已绑定 '..keyPressed:sub(14)..' 到 '..Cmdbar_2.Text..(newToggle and " / "..Cmdbar_3.Text or ""))
			end
		end
	end
end)
...
ClickTP.Select.MouseButton1Click:Connect(function()
	if keySelected then
		...
		updatesaves()
		if keyPressed == 'RightClick' or keyPressed == 'LeftClick' then
			notify('快捷键已更新','已绑定 '..keyPressed..' 到点击传送')
		else
			notify('快捷键已更新','已绑定 '..keyPressed:sub(14)..' 到点击传送')
		end
	end
end)
...
ClickDelete.Select.MouseButton1Click:Connect(function()
	if keySelected then
		...
		updatesaves()
		if keyPressed == 'RightClick' or keyPressed == 'LeftClick' then
			notify('快捷键已更新','已绑定 '..keyPressed..' 到点击删除')
		else
			notify('快捷键已更新','已绑定 '..keyPressed:sub(14)..' 到点击删除')
		end
	end
end)
...
function addPlugin(name)
	if name:lower() == 'plugin file name' or name:lower() == 'iy_fe.iy' or name == 'iy_fe' then
		...
		if file then
			...
			notify('插件错误','找不到文件 "'..fileName..'"。文件在正确的文件夹中吗？')
		end
	end
end
...
function LoadPlugin(val,startup)
	...
	function handlePluginError(plerror)
		...
		print("原始错误: "..tostring(plerror))
		print("插件错误，堆栈回溯: "..tostring(debug.traceback()))
	...
	if plugin ~= nil then
		if not startup then
			notify('已加载插件',"名称: "..plugin["PluginName"].."\n".."描述: "..plugin["PluginDescription"])
		end
		addcmdtext('',val)
...
Plugins.MouseButton1Click:Connect(function()
	if writefileExploit() then
		...
		notify('不兼容的注入器','你的注入器无法使用插件（缺少 read/writefile）')
	end
end)
...
addcmd('addalias',{},function(args, speaker)
	...
	for i,v in pairs(cmds) do
		if v.NAME:lower()==cmd or FindInTable(v.ALIAS,cmd) then
			...
			notify('别名已修改',"已添加 "..alias.." 作为 "..cmd.." 的别名")
			updatesaves()
			refreshaliases()
			break
		end
...
addcmd('removealias',{},function(args, speaker)
	...
	if customAlias[alias] then
		...
		notify('别名已修改',"已从 "..cmd.." 移除别名 "..alias)
		updatesaves()
		refreshaliases()
	end
end)
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if everyClipboard then
		...
		notify('Discord 邀请', '已复制到剪贴板！\ndiscord.gg/78ZuWSq')
	else
		notify('Discord 邀请', 'discord.gg/78ZuWSq')
	end
	if httprequest then
		httprequest({
...
addcmd('keepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = true
		notify('KeepIY','传送后无限收益将继续运行')
		updatesaves()
	else
		notify('不兼容的注入器','你的注入器不支持此命令（缺少 queue_on_teleport）')
	end
end)
...
addcmd('serverinfo',{'info','sinfo'},function(args, speaker)
	...
	task.spawn(function()
		...
		SINFOGUI.name.Text = "地点名称: " .. Asset.Name
		SINFOGUI.playerid.Text = "玩家ID: " ..speaker.UserId
		SINFOGUI.maxplayers.Text = "最大玩家数: "..Players.MaxPlayers
		SINFOGUI.placeid.Text = "地点ID: " ..PlaceId
		...
		repeat
			...
			SINFOGUI.players.Text = #players.. " 名玩家"
			SINFOGUI.appearance.Text = "外观: " ..speaker.CharacterAppearanceId
			...
			if hours < 1 then if minutes < 1 then
					SINFOGUI.Time.Text = seconds .. " 秒" else
					SINFOGUI.Time.Text = minutes .. " 分钟, " .. seconds .. " 秒"
				end
			else
				SINFOGUI.Time.Text = hours .. " 小时, " .. minutes .. " 分钟, " .. seconds .. " 秒"
			end
			wait(1)
...
addcmd('setwaypoint',{'swp','setwp','spos','saveposition','savepos'},function(args, speaker)
	...
	if getRoot(speaker.Character) then
		notify('路径点已修改',"已创建路径点: "..getstring(1, args))
...
addcmd('hideiy',{},function(args, speaker)
	...
	minimizeNum = 0
	minimizeHolder()
	if not (args[1] and tostring(args[1]) == 'nonotify') then notify('IY已隐藏','你可以按前缀键访问命令栏') end
end)
...
addcmd("savegame", {"saveplace"}, function(args, speaker)
	if saveinstance then
		notify("加载中", "正在下载游戏。这需要一些时间")
		saveinstance()
		notify("游戏已保存", "已将地点保存到注入器文件夹中的 workspace 文件夹。")
	else
		notify("不兼容的注入器", "你的注入器不支持此命令（缺少 saveinstance）")
	end
end)
...
addcmd("setfpscap", {"fpscap", "maxfps"}, function(args, speaker)
	...
	elseif num > 0 then
		...
		return notify("无效参数", "请提供一个大于0的数字或 'none'。")
	end
...
addcmd('esp',{},function(args, speaker)
	if not CHMSenabled then
		...
		notify('ESP','请先禁用 chams（nochams）再使用 esp')
	end
end)
...
addcmd('chams',{},function(args, speaker)
	if not ESPenabled then
		...
		notify('Chams','请先禁用 ESP（noesp）再使用 chams')
	end
end)
...
addcmd('notifyfreecamposition',{'notifyfcpos'},function(args, speaker)
	if fcRunning then
		...
		notify("当前位置", Format("%s, %s, %s", Round(X), Round(Y), Round(Z)))
	end
end)
...
addcmd("enableshiftlock", {"enablesl", "shiftlock"}, function(args, speaker)
	...
	enableShiftlock()
	notify("Shiftlock", "Shift lock 现在应该可用")
end)
...
addcmd('noclipcam', {'nccam'}, function(args, speaker)
	...
	if not sc or not getgc or not gc then
		return notify('不兼容的注入器', '你的注入器不支持此命令（缺少 setconstant 或 getconstants 或 getgc）')
	end
...
addcmd('delete',{'remove'},function(args, speaker)
	...
	notify('已删除项目','已删除 ' ..getstring(1, args))
end)
...
addcmd('deleteclass',{'removeclass','deleteclassname','removeclassname','dc'},function(args, speaker)
	...
	notify('已删除项目','已删除 ClassName 为 ' ..getstring(1, args)..' 的项目')
end)
...
addcmd('age',{},function(args, speaker)
	...
	for i,v in pairs(players) do
		local p = Players[v]
		table.insert(ages, p.Name.." 的年龄是: "..p.AccountAge)
	end
	notify('账号年龄',table.concat(ages, ',\n'))
end)
...
addcmd('joindate',{'jd'},function(args, speaker)
	...
	for i,v in pairs(players) do
		...
		local now = os.time()
		local dateJoined  = p.Name .. " 加入日期: " .. os.date("%m/%d/%y", now - secondsOld)

		table.insert(dates, dateJoined)
	end
	notify('加入日期 (月/日/年)',table.concat(dates, ',\n'))
end)
...
addcmd('setcreatorid',{'setcreator'},function(args, speaker)
	if game.CreatorType == Enum.CreatorType.User then
		...
		notify('已设置ID','已将UserId设置为 '..game.CreatorId)
	elseif game.CreatorType == Enum.CreatorType.Group then
		local OwnerID = GroupService:GetGroupInfoAsync(game.CreatorId).Owner.Id
		speaker.UserId = OwnerID
		notify('已设置ID','已将UserId设置为 '..OwnerID)
	end
end)
...
addcmd('2022materials',{'use2022materials'},function(args, speaker)
	if sethidden then
		...
		notify('不兼容的注入器','你的注入器不支持此命令（缺少 sethiddenproperty）')
	end
end)
...
addcmd("orbit", {}, function(args, speaker)
	...
	if target and target.Character and getRoot(target.Character) and root and humanoid then
		...
		notify("轨道", "已开始围绕 " .. formatUsername(target) .. " 旋转")
	end
end)
...
addcmd("unorbit", {}, function(args, speaker)
	...
	if args[1] ~= "nonotify" then notify("轨道", "已停止围绕玩家旋转") end
end)
...
addcmd('muteboombox',{},function(args, speaker)
	if not notifiedRespectFiltering and SoundService.RespectFilteringEnabled then notifiedRespectFiltering = true notify('RespectFilteringEnabled','RespectFilteringEnabled 设置为 true（命令仍然有效但可能仅客户端生效）') end
	local players = getPlayer(args[1], speaker)
	if players ~= nil then
		for i,v in pairs(players) do
			task.spawn(function()
...
addcmd("team", {}, function(args, speaker)
	...
	if not team then
		return notify("无效队伍", teamName .. " 不是有效的队伍")
	end
		...
		for _, v in pairs(player.Character:FindFirstChildWhichIsA("Humanoid"):GetPlayingAnimationTracks()) do
			...
			if not string.find(animationId, "507768375") and not string.find(animationId, "180435571") then
				if assetId then
					...
					local name = success and result or "获取名称失败"
					found = found .. "\n\n名称: " .. name .. "\n动帧ID: " .. animationId
				else
					found = found .. "\n\n动帧ID: " .. animationId
				end
...
addcmd('refreshanimations', {'refreshanimation', 'refreshanims', 'refreshanim'}, function(args, speaker)
	...
	if not Human or not Animate then
		return notify('刷新动帧', '无法获取 Animate/Humanoid')
	end
...
addcmd("clickteleport", {}, function(args, speaker)
    ...
    notify("点击传送", "前往 设置 > 快捷键 > 添加 设置点击传送")
end)
...
addcmd('clickdelete',{},function(args, speaker)
	if speaker == Players.LocalPlayer then
		notify('点击删除','前往 设置 > 快捷键 > 添加 设置点击删除')
	end
end)
...
addcmd('getposition',{'getpos','notifypos','notifyposition'},function(args, speaker)
	...
	for i,v in pairs(players)do
		...
		if not pos then
			return notify('获取位置错误','缺少角色')
		end
		local roundedPos = math.round(pos.X) .. ", " .. math.round(pos.Y) .. ", " .. math.round(pos.Z)
		notify('当前位置',roundedPos)
	end
end)
...
addcmd('spoofspeed',{'spoofws','spoofwalkspeed'},function(args, speaker)
	if args[1] and isNumber(args[1]) then
		if hookmetamethod then
			...
			notify('不兼容的注入器','你的注入器不支持此命令（缺少 hookmetamethod）')
		end
	end
end)
...
addcmd('tools',{'gears'},function(args, speaker)
	...
	notify('工具','已从 ReplicatedStorage 和 Lighting 复制工具')
end)
...
addcmd('fireclickdetectors',{'firecd','firecds'}, function(args, speaker)
	if fireclickdetector then
		...
		notify("不兼容的注入器", "你的注入器不支持此命令（缺少 fireclickdetector）")
	end
end)
...
addcmd('fireproximityprompts',{'firepp'},function(args, speaker)
	if fireproximityprompt then
		...
		notify("不兼容的注入器", "你的注入器不支持此命令（缺少 fireproximityprompt）")
	end
end)
...
addcmd('notifyping',{'ping'},function(args, speaker)
	notify("延迟", math.round(speaker:GetNetworkPing() * 1000) .. "ms")
end)
...
addcmd('spawnpoint',{'spawn'},function(args, speaker)
	...
	notify('重生点','已在 '..tostring(spawnpos)..' 创建重生点')
end)
...
addcmd('clearhats',{'cleanhats'},function(args, speaker)
	if firetouchinterest then
		...
		notify("不兼容的注入器","你的注入器不支持此命令（缺少 firetouchinterest）")
	end
end)
...
addcmd("chatlogswebhook", {"logswebhook"}, function(args, speaker)
	if not httprequest then
		return notify("不兼容的注入器", "你的注入器不支持此命令（缺少 request）")
	end
...
addcmd("handlekill", {"hkill"}, function(args, speaker)
	if not firetouchinterest then
		return notify("不兼容的注入器", "你的注入器不支持此命令（缺少 firetouchinterest）")
	end
	if not speaker.Character then return end
	local tool = speaker.Character:FindFirstChildWhichIsA("Tool")
	local handle = tool and tool:FindFirstChild("Handle")
	if not handle then
		return notify("工具击杀", "你需要持有一个\"工具\"，例如常见的剑类工具，并且该工具在触摸时会造成伤害。")
	end
	local range = tonumber(args[2]) or math.huge
	if range ~= math.huge then notify("工具击杀", ("已启动！\n半径: %s"):format(tostring(range):upper())) end
	...
	if player:IsInGroup(RolewatchData.Group) then
		if tostring(player:GetRoleInGroup(RolewatchData.Group)):lower() == RolewatchData.Role:lower() then
			if RolewatchData.Leave == true then
				Players.LocalPlayer:Kick("\n\n角色监控\n玩家 \"" .. tostring(player.Name) .. "\" 已加入，角色为 \"" .. RolewatchData.Role .. "\"\n")
			else
				notify("角色监控", "玩家 \"" .. tostring(player.Name) .. "\" 已加入，角色为 \"" .. RolewatchData.Role .. "\"")
			end
		end
	end
end)
...
addcmd("rolewatch", {}, function(args, speaker)
	...
	if groupId and roleName then
		...
		notify("角色监控", "正在监视群组 ID \"" .. tostring(groupId) .. "\" 的角色 \"" .. roleName .. "\"")
	end
end)
...
addcmd("rolewatchleave", {"unrolewatch"}, function(args, speaker)
	...
	notify("角色监控", RolewatchData.Leave and "离开已启用" or "离开已禁用")
end)
	...
	if game.CreatorType == Enum.CreatorType.Group then
		...
		staffwatchjoin = Players.PlayerAdded:Connect(function(player)
			...
			if result.Staff then
				notify("员工监控", formatUsername(player) .. " 是 " .. result.Role)
			end
		end)
		for _, player in pairs(Players:GetPlayers()) do
			local result = getStaffRole(player)
		...
		if #found > 0 then
			notify("员工监控", table.concat(found, ",\n"))
		else
			notify("员工监控", "已启用")
		end
	else
		notify("员工监控", "游戏不属于任何群组")
	end
end)
...
addcmd("findfriendgroups", {}, function(args, speaker)
    ...
    createPopup("好友群组", found == 0 and "无" or result)
end)
...
addcmd('clearnilinstances',{'nonilinstances','cni'},function(args, speaker)
	if getnilinstances then
		...
		notify('不兼容的注入器','你的注入器不支持此命令（缺少 getnilinstances）')
	end
end)
...
addcmd("jerk", {}, function(args, speaker)
	...
	tool.Name = "打... "
	tool.ToolTip = "在脱衣舞俱乐部里。直接\"打...\"。所谓\"它\"，哈哈，好吧。就说是我的...吧。"
...
addcmd('autokeypress',{'keypress'},function(args, speaker)
	if keypress and keyrelease and args[1] then
		...
		if not code then notify('自动按键',"无效按键") return end
		...
		notify('Auto Key Press',"按 [退格键] 和 [=] 同时停止")
		repeat wait(clickDelay)
			keypress(code)
			wait(releaseDelay)
			keyrelease(code)
		...
		notify('Auto Key Press',"您的注入器不具备使用自动按键的功能")
	end
end)
...
addcmd("addallplugins", {"loadallplugins"}, function(args, speaker)
	if not listfiles or not isfolder then
		notify("注入器不兼容", "您的注入器不支持此命令 (缺少 listfiles/isfolder)")
		return
	end
...
task.spawn(function()
	...
	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify("版本已过期", "在 infyiff.github.io 获取新版本")
		end
