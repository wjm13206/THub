...
modulesToFetch = {
    ...
    ["TPJump"] = baseUrl .. "/modules/movement/TPJump.lua",
    ["TornadoModule"] = baseUrl .. "/modules/combat/TornadoModule.lua",
    ["OrbitTools"] = baseUrl .. "/modules/combat/OrbitToolsModule.lua",
    ["TCPTrigger"] = baseUrl .. "/modules/utility/TCPTrigger.lua",
