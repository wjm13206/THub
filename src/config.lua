...
data = {
    ...
    scriptlist = {
        { name = "高级聊天系统", link = "https://raw.gitcode.com/Furrycalin/RobloxScripts/raw/main/customChatSystem.lua" },
        { name = "飞行V4", link = "https://raw.gitcode.com/Furrycalin/RobloxScripts/raw/main/FlyV4.lua" },
        { name = "IY5.5.9(指令挂)(汉化版)", link = "https://raw.gitcode.com/Furrycalin/RobloxScripts/raw/main/IY.lua" },
        { name = "Dex", link = "https://raw.githubusercontent.com/infyiff/backup/main/dex.lua" },
        { name = "DexDark", link = "https://raw.gitcode.com/Furrycalin/RobloxScripts/raw/main/DexDark.lua" },
        { name = "SimpleSpy", link = "https://raw.gitcode.com/Furrycalin/RobloxScripts/raw/main/simplespyv3.lua" },
        ...
        { name = "Doors扫描器", link = "https://raw.gitcode.com/Furrycalin/RobloxScripts/raw/main/DoorsNVC3000.lua" },
        { name = "冬凌中心", link = "https://raw.gitcode.com/Furrycalin/RobloxScripts/raw/main/DongLingLobby.lua" },
        { name = "玩家控制", link = "https://raw.gitcode.com/Furrycalin/RobloxScripts/raw/main/PlayerControl.lua" },
